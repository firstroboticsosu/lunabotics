...
private:
  ...
  // Returns: if a byte was successfully read
  bool readOneByteWithTimeout(int in_adr, int timeout_ms, int *result);

  // Returns: if two bytes were successfully read
  bool readTwoByteTogetherWithTimeout(int in_adr, int timeout_ms, int *result);
